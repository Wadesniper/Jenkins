...
pipeline {
    environment {
        ...
        APP_NAME = "ulrich"
        STG_API_ENDPOINT = "ip10-0-0-3-chmeq2bt7uqgqfk0uof0-1993.direct.docker.labs.eazytraining.fr"
        STG_APP_ENDPOINT = "ip10-0-0-3-chmeq2bt7uqgqfk0uof0-8080.direct.docker.labs.eazytraining.fr"
        PROD_API_ENDPOINT = "ip10-0-0-3-chmeq2bt7uqgqfk0uof0-1993.direct.docker.labs.eazytraining.fr"
        PROD_APP_ENDPOINT = "ip10-0-0-3-chmeq2bt7uqgqfk0uof0-80.direct.docker.labs.eazytraining.fr"
        INTERNAL_PORT = "80"
